...
Возвращает разные наборы данных для инвесторов, партнеров и владельца стратегии.
Массив PublicOffers виден только владельцу стратегии.
Массив PrivateOffers виден владельцу полностью, другим клиентам видны только элементы где они указаны в качестве партнеров.  
...
FeeRate	|	real	|	Размер вознаграждения	|
CommissionRate |	real	|	Размер комиссии	|
IsPublic |	boolead	|	признак публичной стратегии	|
***PublicOffers (вложенный массив)***
ID	|	number	|	ID оферты	|
