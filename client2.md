...
Инвестор получает информацию только о текущей публичной оферте
Партнер получает информацию о публичной оферте и скрытым офертам, в которых он указаны в качестве партнера.
