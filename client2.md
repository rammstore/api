...
Нужно заполнить одно из полей: ID, Link, AccountID. 
...
Получение по AccountID возможно только владельцу данного счета. 
...
Инвестор получает информацию только о публичной оферте.
