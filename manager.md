...
URL вызова: https://maindc.ramm.store/api/manager/v1/session.getMySessions
...
URL вызова: https://maindc.ramm.store/api/manager/v1/session.logout
...
URL вызова: https://maindc.ramm.store/api/manager/v1/sessions.search
